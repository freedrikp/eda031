...
\subsection{Client}
The client is divided into four parts. These four parts consists of two classes, one struct and a file containing a few methods including the \texttt{main}-method of the client itself. Out of these foru parts we have only developed two. An overview of the client parts is shown in figure \ref{clientUML}.
